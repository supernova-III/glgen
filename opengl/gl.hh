...
extern void (KHRONOS_APIENTRY* glEnable)(GLenum  cap);
extern GLboolean (KHRONOS_APIENTRY* glIsEnabled)(GLenum  cap);
extern void (KHRONOS_APIENTRY* glVertexAttribPointer)(GLuint  index, GLint  size, GLenum  type, GLboolean  normalized, GLsizei  stride, const void * pointer);
extern void (KHRONOS_APIENTRY* glBufferData)(GLenum  target, GLsizeiptr  size, const void * data, GLenum  usage);
extern void (KHRONOS_APIENTRY* glGenBuffers)(GLsizei  n, GLuint * buffers);
extern void (KHRONOS_APIENTRY* glGenVertexArrays)(GLsizei  n, GLuint * arrays);
extern void (KHRONOS_APIENTRY* glBindVertexArray)(GLuint  array);
extern void (KHRONOS_APIENTRY* glBindBuffer)(GLenum  target, GLuint  buffer);
extern void (KHRONOS_APIENTRY* glEnableVertexAttribArray)(GLuint  index);
extern void (KHRONOS_APIENTRY* glDrawElements)(GLenum  mode, GLsizei  count, GLenum  type, const void * indices);
extern void (KHRONOS_APIENTRY* glDebugMessageCallback)(GLDEBUGPROC  callback, const void * userParam);
extern void (KHRONOS_APIENTRY* glDebugMessageControl)(GLenum  source, GLenum  type, GLenum  severity, GLsizei  count, GLuint * ids, GLboolean  enabled);
extern GLuint (KHRONOS_APIENTRY* glCreateShader)(GLenum  type);
extern void (KHRONOS_APIENTRY* glDeleteShader)(GLuint  shader);
extern void (KHRONOS_APIENTRY* glShaderSource)(GLuint  shader, GLsizei  count, GLchar *const* string, GLint * length);
extern void (KHRONOS_APIENTRY* glCompileShader)(GLuint  shader);
extern GLuint (KHRONOS_APIENTRY* glCreateProgram)();
extern void (KHRONOS_APIENTRY* glAttachShader)(GLuint  program, GLuint  shader);
extern void (KHRONOS_APIENTRY* glLinkProgram)(GLuint  program);
extern void (KHRONOS_APIENTRY* glUseProgram)(GLuint  program);
extern void (KHRONOS_APIENTRY* glGetShaderiv)(GLuint  shader, GLenum  pname, GLint * params);
extern void (KHRONOS_APIENTRY* glGetProgramiv)(GLuint  program, GLenum  pname, GLint * params);
extern void (KHRONOS_APIENTRY* glDeleteProgram)(GLuint  program);
extern void (KHRONOS_APIENTRY* glPolygonMode)(GLenum  face, GLenum  mode);
extern void (KHRONOS_APIENTRY* glClear)(GLbitfield  mask);
extern void (KHRONOS_APIENTRY* glClearColor)(GLfloat  red, GLfloat  green, GLfloat  blue, GLfloat  alpha);
extern void (KHRONOS_APIENTRY* glDrawArrays)(GLenum  mode, GLint  first, GLsizei  count);
extern void (KHRONOS_APIENTRY* glViewport)(GLint  x, GLint  y, GLsizei  width, GLsizei  height);
...
extern HGLRC (KHRONOS_APIENTRY* wglCreateContextAttribsARB)(HDC  hDC, HGLRC  hShareContext, const int * attribList);
